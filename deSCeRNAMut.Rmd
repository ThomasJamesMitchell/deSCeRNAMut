...
The code used to run the above steps, including the pileup os scRNAseq and whole exome sequencing BAMS is provided [here](https://github.com/ThomasJamesMitchell/deSCeRNAMut/blob/main/scripts/benchmarkByWES.txt)
